...
// when user clicks the correct answer, move on to next question
// when user clicks the wrong answer, move on to next question and remove 5 seconds from their timer
