...
var questionRetriever = function () {
  ...
  return { cq: currentQuestion, ra: rightAnswer, ac: answerChoices };
};

// Generation of question Graphical User Interface
var initialFormGenerator = function () {
  displayTitleE.textContent =
    "Welcome to the Javascript QuizEl by DrDano! Push the button below to begin the timed quiz.";
...
var endScreenPresenter = function (trigger) {
  ...
  displayTitleE.textContent =
    "The quiz has ended or timed out. Enter your initials and push 'Submit' to record your score.";
